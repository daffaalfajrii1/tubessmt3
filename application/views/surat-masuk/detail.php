...
<div class="container-fluid">
    ...
    <div class="row my-4">
        ...
        <div class="col">
            ...
            <a href="<?= base_url('surat-masuk/ubah/') . $surat['id']; ?>" class="float-right btn btn-success">Ubah</a>
            <a href="<?= base_url('surat-masuk'); ?>" class="float-right btn btn-warning mr-2">Kembali</a>
        </div>
    </div>
