        ...
        <div class="col-12">
            ...
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <a href="<?= base_url('memo-keluar/tambah'); ?>" target="_blank" class="btn btn-success shadow-sm"><i class="fas fa-fw fa-plus"></i> Tambah Data</a>
                </div>
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-striped display nowrap" style="width: 100%;" id="dataMk">
                            <thead>
                                <tr>
                                    <th>Penerima</th>
                                    <th>Tanggal</th>
...
<div class="modal fade" id="modalHapus" tabindex="-1" role="dialog" aria-labelledby="modelTitleId" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="<?= base_url('mk/hapus'); ?>" method="post">
