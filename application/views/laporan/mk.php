<div class="container-fluid">
        ...
        <div class="col-10">
            ...
            <div class="card shadow-sm my-3">
                <div class="card-body border-left-info rounded-sm">
                    <i class="fa fa-fw fa-info-circle fa-lg"></i> <strong> Silahkan pilih tanggal memo untuk menemukan memo keluar yang diinginkan.</strong>
                </div>
            </div>
    ...
    <div class="row">
        <div class="col-12">
            <form action="<?= base_url('laporan/mk') ?>" method="post">
                <div class="form-row">
                    <div class="col-3">
                    ...
                    <div class="col-3">
                        ...
                        <select name="filterby" class="form-control shadow-sm border-left-success" id="filterby" required>
                            ...
                            <option value="created_at">Tanggal Memo</option>
                        </select>
    ...
    <div class="row mt-3">
        <div class="col-12">
            <table class="table table-sm table-striped">
                ...
                <tbody>
                    <?php if (isset($memo_keluar)) : ?>
                        <?php if (empty($memo_keluar)) : ?>
                            <td colspan="5">
                                <h3 class="text-center">Data tidak ditemukan.</h3>
                            </td>
                        <?php else : ?>
                            <?php foreach ($memo_keluar as $num => $mk) : ?>
                                <tr>
                                    <td><?= $num + 1; ?></td>
                                    <td><?= $mk['pengirim']; ?></td>
                                    <td><?= $mk['created_at']; ?></td>
                                    <td>
                                        <a href="<?= base_url('memo-keluar/') . $mk['id']; ?>" target="_blank" class="btn btn-sm btn-success">Detail</a>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
                        <?php endif; ?>
